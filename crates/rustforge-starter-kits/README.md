...
rustforge starter kits for RustForge
...
```toml
[dependencies]
rustforge-starter-kits = { path = "../rustforge-starter-kits" }
```

## Usage

```rust
use rustforge-starter-kits::*;
...
```bash
cargo doc --package rustforge-starter-kits --open
```
