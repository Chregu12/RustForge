...
Advanced input handling with array support and validation
...
```toml
[dependencies]
foundry-advanced-input = { path = "../foundry-advanced-input" }
```

## Usage

```rust
use foundry-advanced-input::*;
...
```bash
cargo doc --package foundry-advanced-input --open
```
