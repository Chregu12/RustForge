...
mod integration_tests {
    ...
    fn test_password_reset_flow() {
        use rf_auth_scaffolding::models::PasswordReset;
        use rf_auth_scaffolding::password::PasswordResetManager;
    ...
    fn test_email_verification_flow() {
        use rf_auth_scaffolding::email_verification::EmailVerificationManager;
        use rf_auth_scaffolding::models::EmailVerification;
    ...
    fn test_two_factor_authentication_flow() {
        use rf_auth_scaffolding::two_factor::TwoFactorService;
    ...
    fn test_session_management() {
        use rf_auth_scaffolding::session::SessionManager;
