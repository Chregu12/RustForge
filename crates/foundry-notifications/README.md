...
Multi-channel notification system (Database, Email, SMS, Slack, Push)
...
```toml
[dependencies]
foundry-notifications = { path = "../foundry-notifications" }
```
...
```bash
cargo doc --package foundry-notifications --open
```
