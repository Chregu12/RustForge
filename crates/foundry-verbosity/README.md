...
Verbosity level support for CLI commands (-v, -vv, -vvv)
...
```toml
[dependencies]
foundry-verbosity = { path = "../foundry-verbosity" }
```

## Usage

```rust
use foundry-verbosity::*;
...
```bash
cargo doc --package foundry-verbosity --open
```
