...
Application layer orchestration for Foundry Core
...
```toml
[dependencies]
foundry-application = { path = "../foundry-application" }
```

## Usage

```rust
use foundry-application::*;
...
```bash
cargo doc --package foundry-application --open
```
