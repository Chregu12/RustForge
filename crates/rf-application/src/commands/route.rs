    ...
    fn get_routes() -> Vec<RouteEntry> {
        ...
        vec![
            RouteEntry {
                ...
                handler: "rf_api::http::health".to_string(),
            },
            RouteEntry {
                method: "GET".to_string(),
                path: "/commands".to_string(),
                name: "commands".to_string(),
                handler: "rf_api::http::commands".to_string(),
            },
            RouteEntry {
                method: "POST".to_string(),
                path: "/invoke".to_string(),
                name: "invoke".to_string(),
                handler: "rf_api::http::invoke".to_string(),
            },
            RouteEntry {
                method: "POST".to_string(),
                path: "/upload".to_string(),
                name: "upload".to_string(),
                handler: "rf_api::upload::upload_file".to_string(),
            },
        ]
    }
