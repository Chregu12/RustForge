...
/// # Example
/// ```no_run
/// use rf_interactive::ask_with_default;
///
...
/// # Example
/// ```no_run
/// use rf_interactive::{choice, SelectOption};
///
/// let options = vec![
...
/// # Example
/// ```no_run
/// use rf_interactive::{multi_select, SelectOption};
///
/// let options = vec![
...
/// # Example
/// ```no_run
/// use rf_interactive::autocomplete;
///
