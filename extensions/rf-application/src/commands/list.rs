...
use rf_console::{BorderStyle, Colorize, Table, TableCell, TableRow};
...
impl FoundryCommand for ListCommand {
    ...
    async fn execute(&self, ctx: CommandContext) -> Result<CommandResult, CommandError> {
        ...
        let message = match ctx.format {
            rf_plugins::ResponseFormat::Human => {
            ...
            rf_plugins::ResponseFormat::Json => format!("{total} commands available"),
        };
